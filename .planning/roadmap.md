...
Items 1–10 and 12–14 are done. They include the static page cache, discovery introspection, post meta, the ACF package split, rewrite rules, settings pages, block bindings, the starter/demo split, object-storage integration, and releases from `0.5.0` through `0.6.2`.
