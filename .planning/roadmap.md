...
| 2   | `#[AsDiscovery]`               | Approved      | [post_meta_and_acf_split_spec.md](post_meta_and_acf_split_spec.md) §1 | 1–2 d  |
| 3   | `wp foehn discovery:list`      | Approved      | [framework_additions_spec.md](framework_additions_spec.md) §1         | 1 d    |
