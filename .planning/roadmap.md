...
| 12  | Object storage for uploads     | **Undecided** | [uploads_object_storage_spec.md](uploads_object_storage_spec.md)      | 6–8 d  |
| 13  | Release `0.5.0`                | Blocked       | —                                                                     | —      |
...
| Object storage for uploads                | Uploads are the one thing a generated web root does not make disposable, and the gap was recorded twice before it was specced. Specced now — [uploads_object_storage_spec.md](uploads_object_storage_spec.md) — and undecided on one question the spec cannot answer: whether Føhn sites are being deployed anywhere the local disk does not persist. `humanmade/s3-uploads` covers the case that arrives first. |
